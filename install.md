...
In MSYS:
```
export R_HOME=/c/progra~1/R/R-4.5.2 
...
```
setx R_HOME "C:\Program Files\R\R-4.5.2" /M
```
### Optionally:
...
for example (without quotes) "C:\Program Files\R\R-4.5.2".
...
For example (without quotes), add "C:\Program Files\R\R-4.5.2\bin\x64" or
